...
To transfer data from old versions of this sheet to newer ones, you can copy and paste data from the Results Tables page and the League Management page. Also be sure to match the league settings in the new sheet with that of the old sheet. 
